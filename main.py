...
Pipeline:
  ...
  2. If facing the camera, the visitor gets a greeting in two parts: a short spoken
     hello rendered from a template (Part 1) and a hidden-acrostic card of questions
     about generative AI, generated by Qwen3.5 (GGUF, CPU), for the visitor to chew
     on (Part 2). See greeter.py / questions.py.
